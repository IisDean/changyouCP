(function () {
    var JoinActivity = function () {
        ...
        var _isOut = false;
        if(_host.indexOf('activity.changyou.com') < 0){
    ...
    JoinActivity.fn = JoinActivity.prototype = {
        ...
        getDomain: function () {
            if(undefined == this.options){console.error("option undefined");}// return "http://join-activity.changyou.com";
            ...
            this.ajax({
                ...
                success: function () {
                    if (ja.options.platform == 'changyou' || ja.options.platform == 'warframe') {
                        ...
                        location.href = "https://member.changyou.com/logout?b=" + currURL;
                    } else {
                        location.reload();
                    }
                }
